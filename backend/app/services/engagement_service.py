...
Notification storage is's event table; replaces it with the
...
class EngagementService:
    ...
    async def feed_items(
        ...
        *,
        ...
        default feed; dismissed *status* is semantic and stays.
        """
    ...
    def _quiet_suppressed(params: dict) -> bool:
        """Per-rule quiet hours: suppress *pings* inside the
        window. Pre-36 this runs at emit; moves it to dispatch."""
