...
function makeProfile(): Profile {
  return {
    ...
    preferences: { scoring_weights: { skills: 3, location: 3, experience: 3, education: 3, interests: 3, values: 3 } },
    constraints: { physical_conditions: [], max_education_years: null, willing_to_relocate: true, hours_available_per_week: null, salary_min: null, salary_negotiable: false, travel_days_per_month: null, shift_tolerance: null, commute_radius_km: null },
    ai_summary: null,
