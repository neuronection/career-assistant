    ...
    return (
      <div className="flex flex-col items-center gap-1.5">
        <a
          ...
          target="_blank"
          rel="noreferrer"
          title={t("footer.partOfNeuronection")}
          aria-label={t("footer.partOfNeuronection")}
        ...
        <button
          type="button"
          title={t("footer.supportProject")}
          aria-label={t("footer.supportProject")}
        ...
        <div className="w-full rounded-[var(--as-radius)] bg-slate-50 px-2 pb-1.5 pt-2">
          ...
          {FAMILY_LINKS.map(({ name, Mark, href, current }) => (
            ...
            >
              ...
              <span className="font-medium text-slate-500">{t("footer.assistant")}</span>
              <ArrowUpRight
                aria-hidden
