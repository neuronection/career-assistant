...
WRITE_SYSTEM = (
    ...
    "it away. An item's description must add new information only: the "
    "document already prints the item's name and organisation as its "
    "row heading, so never restate them inside the description. "
    "LINKED SOURCES (when present) are text fetched from the "
